Feature: Feed Creation
  ...
  Scenario: Creating a new feed
    ...
    Then I am redirected to the feeds page
      And I see the message "Thanks for adding the feed from http://www.example.com/feed.atom. We will fetch the items soon. The feed has also been added to your feeds folder in the sidebar."
  ...
  Scenario: Creating an existing feed
    ...
    When I create a feed for "http://www.example.com/feed.atom"
    Then I am redirected to the feeds page
      And I see the message "We already have the feed from http://www.example.com/feed.atom, however we will update it now. The feed has also been added to your feeds folder in the sidebar."
      And I see the feed for "http://www.example.com/feed.atom"
