  ...
  module RSpec    
    ...
    class SeleniumTestReportFormatter < Spec::Runner::Formatter::HtmlFormatter
      ...
      def example_failed(example, counter, failure)
        ...
        Selenium::RSpec::SeleniumTestReportFormatter.capture_system_state(example.selenium_driver, example)
        if example.selenium_driver.session_started?
          example.selenium_driver.set_context "Ending example '#{example.description}'"
        end
